      ...
      <body>		
		...
		<xsl:for-each select="//character">
			...
			<div id="page1" class="page">
				...
				<!-- Layout basic info -->
				<div class="sheetData" style="top: 66; left: 65;width: 100px; word-wrap: break-word;"><xsl:value-of select="name" /></div>
				<!-- Top Line data -->
				...
				<!-- Attributes -->
				<div class="sheetDataBig" style="top: 136; left: 36;"><xsl:if test="$strBonus &gt;= 0">+</xsl:if><xsl:value-of select="$strBonus" /></div><div class="sheetDataSmall" style="top: 167; left: 44;"><xsl:value-of select="abilities/strength/score" /></div><div class="sheetDataBig" style="top: 200; left: 36;"><xsl:if test="$dexBonus &gt;= 0">+</xsl:if><xsl:value-of select="$dexBonus" /></div>
				
				
				<div class="sheetDataSmall" style="top: 232; left: 44;"><xsl:value-of select="abilities/dexterity/score" /></div>
				
				
				<div class="sheetDataBig" style="top: 265; left: 36;"><xsl:if test="$conBonus &gt;= 0">+</xsl:if><xsl:value-of select="$conBonus" /></div><div class="sheetDataSmall" style="top: 298; left: 44;"><xsl:value-of select="abilities/constitution/score" /></div>
				
				
				<div class="sheetDataBig" style="top: 330; left: 36;"><xsl:if test="$intBonus &gt;= 0">+</xsl:if><xsl:value-of select="$intBonus" /></div><div class="sheetDataSmall" style="top: 363; left: 44;"><xsl:value-of select="abilities/intelligence/score" /></div>
				
				
				<div class="sheetDataBig" style="top: 395; left: 36;"><xsl:if test="$wisBonus &gt;= 0">+</xsl:if><xsl:value-of select="$wisBonus" /></div><div class="sheetDataSmall" style="top: 428; left: 44;"><xsl:value-of select="abilities/wisdom/score" /></div>
				
				
				<div class="sheetDataBig" style="top: 460; left: 36;"><xsl:if test="$chaBonus &gt;= 0">+</xsl:if><xsl:value-of select="$chaBonus" /></div><div class="sheetDataSmall" style="top: 493; left: 44;"><xsl:value-of select="abilities/charisma/score" /></div>
				...
				<div class="sheetDataSmall" style="top: 197; left: 92;"><xsl:if test="abilities/dexterity/saveprof = 1">+</xsl:if></div>
				...
				<div class="sheetDataSmall" style="top: 210; left: 92;"><xsl:if test="abilities/constitution/saveprof = 1">+</xsl:if></div>
				...
				<div class="sheetDataSmall" style="top: 234; left: 92;"><xsl:if test="abilities/wisdom/saveprof = 1">+</xsl:if></div>
				...
				<div class="sheetDataSmall" style="top: 246; left: 92;"><xsl:if test="abilities/charisma/saveprof = 1">+</xsl:if></div>
				...
				<!-- Skills -->
				<div class="sheetDataSmall" style="top: 290; left: 92;"><xsl:if test="skilllist/*[name='Acrobatics']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 289; left: 101;"><xsl:if test="skilllist/*[name='Acrobatics']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Acrobatics']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 287; left: 120;">Acrobatics</div-->
				<div class="sheetDataSmall" style="top: 302; left: 92;"><xsl:if test="skilllist/*[name='Animal Handling']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 301; left: 101;"><xsl:if test="skilllist/*[name='Animal Handling']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Animal Handling']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 299; left: 120;">Animal Handling</div-->
				<div class="sheetDataSmall" style="top: 314; left: 92;"><xsl:if test="skilllist/*[name='Arcana']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 313; left: 101;"><xsl:if test="skilllist/*[name='Arcana']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Arcana']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 311; left: 120;">Arcana</div-->
				<div class="sheetDataSmall" style="top: 327; left: 92;"><xsl:if test="skilllist/*[name='Athletics']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 326; left: 101;"><xsl:if test="skilllist/*[name='Athletics']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Athletics']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 324; left: 120;">Athletics</div-->
				<div class="sheetDataSmall" style="top: 339; left: 92;"><xsl:if test="skilllist/*[name='Deception']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 338; left: 101;"><xsl:if test="skilllist/*[name='Deception']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Deception']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 336; left: 120;">Deception</div-->
				<div class="sheetDataSmall" style="top: 351; left: 92;"><xsl:if test="skilllist/*[name='History']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 350; left: 101;"><xsl:if test="skilllist/*[name='History']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='History']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 348; left: 120;">History</div-->
				<div class="sheetDataSmall" style="top: 363; left: 92;"><xsl:if test="skilllist/*[name='Insight']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 362; left: 101;"><xsl:if test="skilllist/*[name='Insight']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Insight']/total" /></div>
				...
				<div class="sheetDataSmall" style="top: 374; left: 101;"><xsl:if test="skilllist/*[name='Intimidation']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Intimidation']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 372; left: 120;">Intimidation</div-->
				<div class="sheetDataSmall" style="top: 388; left: 92;"><xsl:if test="skilllist/*[name='Investigation']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 388; left: 101;"><xsl:if test="skilllist/*[name='Investigation']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Investigation']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 386; left: 120;">Investigation</div-->
				<div class="sheetDataSmall" style="top: 400; left: 92;"><xsl:if test="skilllist/*[name='Medicine']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 400; left: 101;"><xsl:if test="skilllist/*[name='Medicine']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Medicine']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 398; left: 120;">Medicine</div-->
				<div class="sheetDataSmall" style="top: 413; left: 92;"><xsl:if test="skilllist/*[name='Nature']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 412; left: 101;"><xsl:if test="skilllist/*[name='Nature']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Nature']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 410; left: 120;">Nature</div-->
				<div class="sheetDataSmall" style="top: 425; left: 92;"><xsl:if test="skilllist/*[name='Perception']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 424; left: 101;"><xsl:if test="skilllist/*[name='Perception']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Perception']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 422; left: 120;">Perception</div-->
				<div class="sheetDataSmall" style="top: 437; left: 92;"><xsl:if test="skilllist/*[name='Performance']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 436; left: 101;"><xsl:if test="skilllist/*[name='Performance']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Performance']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 434; left: 120;">Performance</div-->
				<div class="sheetDataSmall" style="top: 449; left: 92;"><xsl:if test="skilllist/*[name='Persuasion']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 448; left: 101;"><xsl:if test="skilllist/*[name='Persuasion']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Persuasion']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 446; left: 120;">Persuasion</div-->
				<div class="sheetDataSmall" style="top: 462; left: 92;"><xsl:if test="skilllist/*[name='Religion']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 461; left: 101;"><xsl:if test="skilllist/*[name='Religion']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Religion']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 459; left: 120;">Religion</div-->
				<div class="sheetDataSmall" style="top: 474; left: 92;"><xsl:if test="skilllist/*[name='Sleight of Hand']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 474; left: 101;"><xsl:if test="skilllist/*[name='Sleight of Hand']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Sleight of Hand']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 472; left: 120;">Sleight of Hand</div-->
				<div class="sheetDataSmall" style="top: 486; left: 92;"><xsl:if test="skilllist/*[name='Stealth']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 486; left: 101;"><xsl:if test="skilllist/*[name='Stealth']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Stealth']/total" /></div>
				<!--div class="sheetDataXXSmall" style="top: 484; left: 120;">Stealth</div-->
				<div class="sheetDataSmall" style="top: 488; left: 160;"><xsl:if test="defenses/ac/disstealth = 1">dis</xsl:if></div>
				<div class="sheetDataSmall" style="top: 498; left: 92;"><xsl:if test="skilllist/*[name='Survival']/prof = 1">+</xsl:if></div>
				<div class="sheetDataSmall" style="top: 498; left: 101;"><xsl:if test="skilllist/*[name='Survival']/total >= 0">+</xsl:if><xsl:value-of select="skilllist/*[name='Survival']/total" /></div>
				...
				<!-- Personality Traits -->
				<div class="sheetDataXXSmall" style="top: 125; left: 380;width: 140;padding-top: 10px;"><xsl:value-of select="personalitytraits" /></div>
				<div class="sheetDataXXSmall" style="top: 185; left: 380;width: 140;padding-top: 10px;"><xsl:value-of select="ideals" /></div>
				<div class="sheetDataXXSmall" style="top: 235; left: 380;width: 140;padding-top: 10px;"><xsl:value-of select="bonds" /></div>
				<div class="sheetDataXXSmall" style="top: 285; left: 380;width: 140;padding-top: 10px;"><xsl:value-of select="flaws" /></div>
